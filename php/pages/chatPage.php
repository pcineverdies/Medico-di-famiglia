...
<?php 
    ...
    if($_SESSION['stato']==-1 && !isset($_SESSION['destinatario']))header("location: ./homePage.php");
    else if ($_SESSION['stato']!=-1)$_SESSION['destinatario']=1;
    ...
    <body onload="loadMessages()">
            ...
            <div id="containerBody">
                <div id="leftSide">
                    ...
                    $user = getUser($_SESSION['destinatario']);
                    echo "<div id=\"userAddress\">Stai chattando con: {$user[0]['nome']} {$user[0]['cognome']}</div>";
                    ?>
                        <div id="messagesContainer">

                        </div>
                        <div id="inputChatContainer">
                            <textarea name="testo" id="inputChat"></textarea>
